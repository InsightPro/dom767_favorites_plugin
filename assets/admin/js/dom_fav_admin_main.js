jQuery(document).ready(function ($) {
	...
	/************************************** Get Ajax URL********************************/
  	...
  	$(document).on('click', '.fav_admin_paginations_pre', function fav_admin_paginations_num(e){
  	...
  	$(document).on('click', '.fav_admin_paginations_next', function fav_admin_paginations_num(e){
